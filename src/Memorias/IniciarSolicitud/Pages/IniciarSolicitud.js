    ...
    return (
        <main className={classes.container}>
            <div className={classes.head}>
                ...
                <p>Los campos que se presentan con un *  son obligatorios</p>
            </div>
            <Card>
                    ...
                    <div className={classes.memoryBody}>
                        ...
                        <div className={classes.memoryFile}>
                            <div className={classes.memoryFileHead}>
                                ...
                                <p>Deberá descargar la planilla que vendrá con los campos que solicita la universidad por reglamentos internos para iniciar el proceso de memoria</p>
                            </div>
                            <Button>
                                Descargar plantilla
                            </Button>
